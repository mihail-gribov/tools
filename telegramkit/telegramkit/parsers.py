...
def bs_to_comments(msg: BeautifulSoup, post: Post) -> Comment:
    ...
    return Comment(
        ...
        text=BeautifulSoup(str(msg.find(class_='js-message_text')).replace('<br/>', '\n'), 'html.parser').text,
        reply=reply,
